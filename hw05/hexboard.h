...
// Problem set 5: hex board

// Header file for hex board
...
typedef
struct {
    double x0;  // screen coordinate of left edge of bounding box
    double y0;  // screen coordinate of bottom edge of bounding box
    double x1;  // screen coordinate of right edge of bounding box
    double y1;  // screen coordinate of top of bounding box
