...
int main()
{
	...
	printf("---------------------Round----------------------------------------------\n");
	printf("Layer Size | Area Used | Portions Available | Total Portions | Total Area\n");
	for(i = 0, tempPortions = 0, tempArea = 0, circlePortions = 0; servingSize * numGuests > usedCircleArea; i++)
	{
		tempArea = (((i+3)*2)*((i+3)*2)*PI)*.25;
		...
		printf("%i          | %g         | %i                  | %i              | %g\n", i*2+6, tempArea, tempPortions, circlePortions, totalCircleArea);
	...
	for (i = 0, tempPortions = 0, tempArea = 0, squarePortions = 0; servingSize * numGuests > usedSquareArea; i++)
	{
		...
		printf("%i          | %g         | %i                  | %i              | %g\n", i*2+6, tempArea, tempPortions, squarePortions, totalSquareArea);
